...
// array di domande e risposte
  $questions = [
    ...
    "question_2" => [
      [
        "question_title" => "Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?",
        "question_reply" => "Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno. <br>
  ...
  <body>
    ...
    <header>
      ...
      <div class="bottom-header flex">
        <div class="bottom-header_navigation">
          <ul>
        ...
        <div class="bottom-header_avatar">
          <img src="img/unnamed.jpg" alt="">
          <span>email.di.prova@gmail.com<span>
        </div>
      </div>
    </header>
    <!-- fine header -->
    ...
    <main>
      <div class="container">
        <?php foreach ($questions as $question){ ?>
          <?php foreach ($question as $question_value){ ?>
            <div class="container_item">
              <!-- Titolo domanda -->
              <h2><?php echo $question_value["question_title"]?></h2>

              <!-- risposta domanda -->
              <p><?php echo $question_value["question_reply"]?></p>
            </div>
          <?php }; ?>
        <?php }; ?>
      </div>
